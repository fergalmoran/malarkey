defmodule RobotterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RobotterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RobotterWeb.Gettext, "errors", msg, opts)
    end
  end
