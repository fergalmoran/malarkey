defmodule RobotterWeb.UserAuthTest do
  use RobotterWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Robotter.Accounts
  alias RobotterWeb.UserAuth
  import Robotter.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RobotterWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RobotterWeb.Endpoint.subscribe(live_socket_id)
